...
class RetryHandler:
    ...
    def get_delay(self, retry_policy: Dict[str, Any], retry_count: int) -> float:
        ...
        Args:
            retry_policy (Dict[str, Any]): Retry policy with strategy and base_delay_seconds.
            retry_count (int): Current retry attempt.

        Returns:
            float: Delay in seconds.
        """
        strategy: str = retry_policy.get("strategy", "exponential_backoff")
    ...
    def delay(self, retry_policy: Dict[str, Any], retry_count: int) -> None:
        ...
        Args:
            retry_policy (Dict[str, Any]): Retry policy.
            retry_count (int): Current retry attempt.
        """
